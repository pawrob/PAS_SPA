<template>
  <div class="login-box">
    ...
    <button  @click="post">Update Employee</button>
  </div>
</template>
...
import axios from "axios";
  ...
  export default {
    ...
    created() {
      ...
      axios.get("https://localhost:8181/PAS_REST-1.0-SNAPSHOT/hr/employees/"+this.$route.query.email, {
    ...
    methods: {
      ...
      post: function () {
        axios.put("https://localhost:8181/PAS_REST-1.0-SNAPSHOT/hr/employees/update/"+this.$route.query.email, {
